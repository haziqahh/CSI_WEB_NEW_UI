          ...
          <div className="h-1500px w-full">
            ...
            <Row className="w-full mt-4 flex justify-between">
              <Col className="w-1/2 bg-darkTeal text-white px-4 pb-8 pt-2 text-lg">
                ...
                <Row className="w-full mt-2">
                  <p className="w-2/5">Assessment Date</p>:
                  <p className="w-2/4 break-words ml-2">
                ...
                <Row className="w-full mt-2">
                  <p className="w-2/5">Report Validity</p>:
                  <p className="w-2/4 break-words ml-2">
                    {Object.keys(completedAssessment).length > 0
            ...
            <Row className="w-full flex justify-between">
              <Col className="w-47%">
                <p className="text-darkGreen font-bold text-xl mt-8 mb-4">
                ...
                {recommended.length > 0
                  ? recommended.map((val, index) => (
                      <div
                        className={
                          "flex items-center gap-x-4 rounded-full px-4 py-2 text-lg text-white hover:text-white focus:text-white border-2 border-gray-300 bg-darkTeal mt-2"
                        }
                      >
                        <p className="bg-white rounded-full text-yellow-600 py-4 px-6 text-lg">
                          {index + 1}
                        </p>
                        <p>{val.title}</p>
                      </div>
              ...
              <Col className="w-47%">
                ...
                <div className="flex justify-center -my-4">
                  {summary.length > 0 ? multiRadarChart(summary, 600) : null}
                </div>
                <div className="flex gap-x-8 justify-center">
                  ...
                  <Badge
                    color="#22c55e"
                    text={
                      <span className="text-darkGreen">Other Companies</span>
                    }
                  ></Badge>
                </div>
              </Col>
        ...
        {allDocName.length > 0 ? (
          <Content>
            <Row className="h-[1550px] mt-20 flex flex-col">
              <p className="text-darkGreen font-bold text-3xl 1400:text-2xl 820:text-xl mt-8 mb-4">
                Supporting Documents
              </p>
              {allDocName.map((val) => (
                <a
                  className={
                    "flex items-center gap-x-4 px-4 py-2 text-2xl 1400:text-xl 820:text-lg text-white hover:text-white focus:text-white border-2 bg-darkTeal mt-2"
                  }
                >
                  <p>{val}</p>
                </a>
            ...
            <Row>
              <p className="font-medium text-justify mt-2 text-darkGreen">
                ...
                this site is provided “as is ” with no guarantee of
                ...
                particular purpose. In no event will CSI, its related
                partnerships and corporations, or the directors, agents or
                employees thereof be liable to you or anyone else for any
                decision made or action taken in reliance on the information in
                this Report or any consequential, special or similar damages,
