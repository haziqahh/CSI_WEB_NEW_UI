...
function HomePage() {
    ...
    if (portfolioData.length > 0 && portfolioDataReady === 1) {
      ...
      linked.map((val, index) => {
        ...
        if (index === linked.length - 1) {
          setTimeout(() => {
            setSmeRank(linked.sort((a, b) => b.score - a.score));
              ...
              if (index === linked.length - 1) {
                ...
                Object.keys(industryObj).map((val, industryIndex) => {
                  ...
                  if (industryIndex === Object.keys(industryObj).length - 1) {
                    setIndustryRank(industryRank.sort((a, b) => b.score - a.score));
                  }
                });
              }
            });
  ...
  return (
    <Layout className="min-h-full">
      <Header></Header>
      <Content className="bg-white px-12 min-h-9/10 w-full pb-8">
        <Row className="mt-8 min-h-8/10 gap-x-8 w-3/5 1400:w-4/5 820:w-full mx-auto">
          <Row className="flex justify-end gap-x-8 w-full font-semibold relative">
            <Button
              ...
              onClick={() => {
                ...
                let data = REPORTURL + "/esg?target=" + WEBURL + "/esg/portfolioPdf?id=" + router.query.id + "&accessToken=" + sessionStorage.getItem("accessToken") + "&role=sme";
          ...
          {/* <Row className="flex justify-end gap-x-8 w-full font-semibold">
            <p>Report Generated on {date}</p>
          </Row>
          <Row className="flex justify-end gap-x-8 w-full font-semibold">
            <p>ESG Report Assessment ID: {Object.keys(completedAssessment).length > 0 ? completedAssessment?.serialNo : ""}</p>
          </Row> */}
          <Row className="w-full flex flex-col">
            <p className="text-darkGreen font-bold text-4xl 1400:text-3xl 820:text-2xl">ESG Portfolio Report</p>
          </Row>
          <Row className="w-full mt-4 flex justify-between">
            <Col className="w-1/2 bg-darkTeal text-white text-base px-4 pb-8 pt-2">
              <Row className="bg-white text-darkTeal p-8 -ml-8 border-darkTeal border-4 flex flex-col">
                <Col>
                  <p className="text-xl 1400:text-lg 820:text-base">ESG Score</p>
                </Col>
                <Col>
                  <p className="text-3xl 1400:text-2xl 820:text-xl font-bold mt-4">
              ...
              {/* <Row className="w-full mt-2">
                <p className="w-1/5">Contact Person</p>:<p className="w-3/4 break-words ml-2">{Object.keys(profile).length > 0 ? profile.title + " " + profile.firstName + " " + profile.lastName : ""}</p>
              </Row>
              <Row className="w-full mt-2">
                <p className="w-1/5">Department</p>:<p className="w-3/4 break-words ml-2">{Object.keys(profile).length > 0 ? profile.department : ""}</p>
              </Row>
              <Row className="w-full mt-2">
                <p className="w-1/5">Designation Level</p>:<p className="w-3/4 break-words ml-2">{Object.keys(profile).length > 0 ? profile.designation : ""}</p>
              </Row> */}
              <Row className="w-full mt-2">
                <p className="w-1/5">Connection Size</p>:<p className="w-3/4 break-words ml-2">{linkedCompanyId.length + " connections"}</p>
              </Row>
              <Row className="w-full mt-2">
                <p className="w-1/5">Portfolio Size</p>:<p className="w-3/4 break-words ml-2">{allAggScoreLength + " reports"}</p>
              </Row>
            </Col>
            <Col className="w-2/5 bg-darkTeal text-white text-base px-4 pb-8 pt-2">
              <Row className="bg-white text-darkTeal px-8 py-5 -ml-8 border-darkTeal border-4 flex items-center justify-between">
                ...
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3 text-center">{allPortfolioScore.Env + "%"}</p>
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3">{getESGLevel(allPortfolioScore.Env)}</p>
              </Row>
              <Row className="bg-white text-darkTeal px-8 py-5 -ml-8 border-darkTeal border-4 flex items-center justify-between mt-2">
                ...
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3 text-center">{allPortfolioScore.Soc + "%"}</p>
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3">{getESGLevel(allPortfolioScore.Soc)}</p>
              </Row>
              <Row className="bg-white text-darkTeal px-8 py-5 -ml-8 border-darkTeal border-4 flex items-center justify-between mt-2">
                <p className="text-2xl 1400:text-xl 820:text-lg w-1/3">Governance</p>
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3 text-center">{allPortfolioScore.Gov + "%"}</p>
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3">{getESGLevel(allPortfolioScore.Gov)}</p>
              </Row>
              <Row className="bg-white text-darkTeal px-8 py-2 -ml-8 border-darkTeal border-4 flex items-center justify-between mt-2">
                ...
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3 text-center">{allPortfolioScore.Sus + "%"}</p>
                <p className="text-3xl 1400:text-xl 820:text-lg font-bold w-1/3">{getESGLevel(allPortfolioScore.Sus)}</p>
              </Row>
            </Col>
          </Row>
          <Row className="w-full flex justify-center text-lg text-darkGreen font-semibold text-center mt-12">
            <p>Portfolio Breakdown by Dimension</p>
          </Row>
          <Row className="w-full flex justify-center text-base text-white font-semibold text-center mt-2 gap-x-1">
            <p className="w-[15%] mr-2"></p>
          ...
          <Row className="w-full flex justify-center text-base text-white mt-2 gap-x-1">
            <p className="w-[15%] text-darkGreen font-semibold text-right mr-2">Environmental</p>
          ...
          <Row className="w-full flex justify-center text-base text-white mt-2 gap-x-1">
            <p className="w-[15%] text-darkGreen font-semibold text-right mr-2">Social</p>
          ...
          <Row className="w-full flex justify-center text-base text-white mt-2 gap-x-1">
            <p className="w-[15%] text-darkGreen font-semibold text-right mr-2">Governance</p>
          ...
          <Row className="w-full flex justify-center text-base text-white mt-2 gap-x-1">
            <p className="w-[15%] text-darkGreen font-semibold text-right mr-2">Sustainable Procurement</p>
          ...
          <Row className="w-full flex justify-center text-base text-white mt-2 gap-x-1">
            <p className="w-[15%] text-darkGreen font-semibold text-right mr-2">Overall</p>
          ...
          <Row className="w-full mt-12">
            <Col className="w-1/3 flex flex-col items-center">
              <p className="text-darkGreen text-base font-semibold text-center">
                Portfolio Breakdown by
                <br />
                Number of Company Branches
              </p>
              {portfolioDonutChartTemp(portfolioBranches, 320, COLORS)}
            ...
            <Col className="w-1/3 flex flex-col items-center">
              ...
              {portfolioDonutChartTemp(portfolioRevenue, 320, SIXCOLORS)}
              <div className="flex flex-col text-sm">
            ...
            <Col className="w-1/3 flex flex-col items-center">
              ...
              {portfolioDonutChartTemp(portfolioSize, 320, COLORS)}
              <div className="flex flex-col text-sm">
          ...
          <Row className="mt-8">
            <p className="text-darkGreen font-semibold text-base">Ranking By Industry</p>
            <Table className="csiTable portfolioTable" dataSource={[...industryRank]} pagination={{ showSizeChanger: true, position: ["bottomLeft"], pageSize: 20 }} rowClassName={(row, index) => (index % 2 === 0 ? "bg-white" : "bg-gray-100")}>
              <Column
                title={<p className="text-sm">Industry</p>}
                dataIndex="industry"
                ...
                render={(industry) => (
                  <Tooltip placement="topLeft" title={industry}>
                    <p className="text-darkGreen text-sm">{industry}</p>
                  </Tooltip>
                )}
              />
              <Column
                title={<p className="text-sm">Environmental</p>}
                sorter={(a, b) => a.Env - b.Env}
                showSorterTooltip={false}
                render={(row) => {
                  return (
                    <div className="flex items-center text-darkGreen text-sm">
              ...
              ></Column>
              <Column
                title={<p className="text-sm">Social</p>}
              ...
              ></Column>
              <Column
                title={<p className="text-sm">Governance</p>}
              ...
              ></Column>
              <Column
                title={<p className="text-sm">Sustainable Procurement</p>}
              ...
              ></Column>
              <Column
                title={<p className="text-sm">ESG Maturity Level</p>}
              ...
              ></Column>
              <Column
                title={<p className="text-sm">Company Percentage</p>}
                sorter={(a, b) => a.percentage - b.percentage}
                showSorterTooltip={false}
                render={(row) => {
                  return <p className="text-darkGreen text-sm">{row.percentage + "%"}</p>;
                }}
              />
            </Table>
          </Row>
          <Row className="mt-8">
            <p className="text-darkGreen font-semibold text-base">Ranking By Company</p>
            <Table className="csiTable portfolioTable" dataSource={[...smeRank]} pagination={{ showSizeChanger: true, position: ["bottomLeft"], pageSize: 20 }} rowClassName={(row, index) => (index % 2 === 0 ? "bg-white" : "bg-gray-100")}>
              <Column
                title={<p className="text-sm">Company Name</p>}
                ...
                render={(name) => (
                  <Tooltip placement="topLeft" title={name}>
                    <p className="text-darkGreen text-sm">{name}</p>
                  </Tooltip>
                )}
              />
              <Column
          ...
          <Row className="mb-8 mt-12">
            <p className="text-darkGreen text-base font-semibold">Company By States</p>
